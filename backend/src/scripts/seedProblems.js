...
/**
 * Database Seed Script for Problems
 * Migrates existing problems from problems.js to MongoDB
 * 
 * Run this script once: node src/scripts/seedProblems.js
 */

// Import existing problems data
const PROBLEMS = {
    "two-sum": {
        id: "two-sum",
        title: "Two Sum",
...
async function seedProblems() {
    try {
        console.log("🌱 Starting problem seed script...");
